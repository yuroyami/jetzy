...
sealed interface JetzyElement {
    val name: String  // you'll need this for the transfer protocol
    val source: RawSource
    suspend fun size(): Long

    data class File(val file: PlatformFile) : JetzyElement {
    ...
    data class Folder(val folder: PlatformFile) : JetzyElement {
        ...
        // call .flatten() first to get a List<JetzyElement> of its children
    }
}